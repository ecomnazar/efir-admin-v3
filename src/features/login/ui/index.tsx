...
export const LoginForm = () => {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="bg-secondary text-textColor w-[90%] sm:w-full max-w-sm min-h-[sm] max-h-[60vh] rounded-md p-6">
      ...
      <Input labelText={'Email or Username'} placeholder='Enter your username' register={register} registerName='username' />
      <Input labelText='Password' placeholder='Enter your password' register={register} registerName='password' />
